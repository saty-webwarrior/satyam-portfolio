...
const Page2 = () => {
    ...
    const animation = () => {
        ...
        const imagePaths = Array.from({length: 151}, (elem, idx) => `/src/assets/canvas/unscreen-${idx}.png`);
        const images = [];
  ...
  return (
    <div id='section2' className='bg-white text-center flex flex-col items-center -mt-10 p-32 text-black'>
        <h3 className='text-gray-500 text-xl font-thin -mt-20'>©  anzo.studio 2024 | designed and developed</h3>
        <div className='rotateText mt-[-10vw] mb-0'>
            <h1 className='text-[18vw] text-black font-bold tracking-tighter leading-[35vw]'>IMPACTFUL</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[18vw] text-black font-bold -mt-20 leading-[10vw] tracking-tighter'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[18vw] text-black font-bold -mt-20 tracking-tighter'>IS THE</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[18vw] text-black font-bold -mt-20 tracking-tighter'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[18vw] text-black font-bold -mt-20 tracking-tighter'>THAT</h1>
        </div>
        <div className='rotateText bg-white relative'>
            <canvas className='h-full w-[80%] -translate-y-8 -translate-x-1/2 left-1/2 absolute'></canvas>
            <h1 className='text-[18vw] text-black font-bold -mt-20 tracking-tighter'>WORKS</h1>
        </div>
        <div className='flex items-center justify-center  w-[90%] scale-x-75'>
    ...
    <g>
        ...
        <div className='h-1 w-[90%] relative left-1/2 -translate-x-1/2 mt-10 bg-black'>
